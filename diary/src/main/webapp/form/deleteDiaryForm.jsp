...
<body>
	...
	<span class="home" style="margin-left: 10px"><a class="btn btn-dark" href="/diary/diaryOne.jsp?diaryDate=<%=diaryDate%>">Back</a></span>
	<%
	if(sessOnRs.next()){
	%>
	...
	%>
		<div class="row">
			...
			<!-- 메인 내용 시작 -->
					...
					<a class="btn btn-dark" href="/diary/action/deleteDiaryAction.jsp?diaryDate=<%=rs.getString("diaryDate")%>&diaryDate=<%=rs.getString("diaryDate")%>">Delete Content</a>
					<%
						}
					%>
			<!-- 메인 내용 끝 -->
